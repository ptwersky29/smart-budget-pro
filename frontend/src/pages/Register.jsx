          ...
          <form onSubmit={onSubmit} noValidate className="space-y-5 mt-8">
            ...
            <div>
              ...
              <input
                ...
                required
                {...field("name")}
                className={`mt-1 w-full control-shell ${errors.name ? "border-ruby" : ""}`}
              />
            ...
            <div>
              ...
              <input
                ...
                required
                {...field("email")}
                className={`mt-1 w-full control-shell ${errors.email ? "border-ruby" : ""}`}
              />
            ...
            <div>
              ...
              <div className="relative mt-1">
                <input
                  ...
                  className={`w-full control-shell pr-11 ${errors.password ? "border-ruby" : ""}`}
                />
                <button
                  type="button"
            ...
            <div>
              ...
              <div className="relative mt-1">
                <input
                  ...
                  className={`w-full control-shell pr-11 ${errors.confirm ? "border-ruby" : ""}`}
                />
                <button
                  type="button"
            ...
            <button
              ...
              disabled={busy}
              className="btn-pill w-full gradient-emerald text-white disabled:opacity-50"
            >
