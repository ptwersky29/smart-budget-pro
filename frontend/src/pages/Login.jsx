          ...
          <form onSubmit={onSubmit} noValidate className="space-y-5 mt-8">
            ...
            <div>
              ...
              <input
                ...
                className={`mt-1 w-full control-shell ${errors.email ? "border-ruby focus:border-ruby" : ""}`}
              />
            ...
            <div>
              ...
              <div className="relative mt-1">
                <input
                  ...
                  className={`w-full control-shell pr-11 ${errors.password ? "border-ruby focus:border-ruby" : ""}`}
                />
                <button
                  type="button"
