...
export default function Logo({ size = "md", className = "" }) {
  ...
  return (
    ...
    >
      ...
      <circle cx="60" cy="60" r="48" stroke="url(#logo-warm-gold)" strokeWidth="1.5" />
      <circle cx="60" cy="60" r="45" stroke="#FFFFFF" strokeOpacity="0.1" strokeWidth="1" />

      <path d="M42 74 C36 68 36 52 46 42" stroke="url(#logo-warm-gold)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
      ...
      <path d="M78 74 C84 68 84 52 74 42" stroke="url(#logo-warm-gold)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
      ...
      <text x="60" y="74" fontFamily="Georgia, 'Times New Roman', serif" fontSize="44" fontWeight="bold" fill="#FFFFFF" textAnchor="middle">P</text>
